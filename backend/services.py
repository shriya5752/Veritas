...
async def run_analysis(img: Image.Image, filename: str) -> AnalysisResponse:
    ...
    print("DEBUG raw keys:", raw.keys())
    print("DEBUG heatmap_b64 length:", len(raw.get("heatmap_b64", "")))
    print("DEBUG mask is None:", raw.get("mask") is None)
    ...
    # ── Step 7: Use heatmap already generated by predict_from_pil ────
    heatmap_b64 = raw.get("heatmap_b64", "")
